...
// 트리의 범위를 계산하는 함수
function getTreeBounds(node: any, type: TreeType): { minX: number; maxX: number; minY: number; maxY: number } {
...
export default function InitialTreeVisualization({
  ...
  useEffect(() => {
    ...
    ctx.restore();
  }, [tree, treeType, bstRenderer, avlRenderer, btreeRenderer, bplusTreeRenderer]);
